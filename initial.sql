...
CREATE TABLE `editors` (
  ...
  `password_salt` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `editors` VALUES (1,1,NULL,NULL,'2019-04-03 15:04:15','2019-04-03 15:04:15',0,0,'Tester','Actor',NULL,'tester@localhost.com','tester','655ed8d6dd71f130e9c9de02f70eab7a','5ca4cb6f2d8f0','admin',NULL,'topsecurity+');
...
CREATE TABLE `files` (
  ...
  `title_original` text COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `tasks` (
  ...
  `performer_code` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
...
-- Dump completed on 2019-08-15  7:14:15
-- MySQL dump 10.16  Distrib 10.1.38-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: zfe
-- ------------------------------------------------------
...
CREATE TABLE `history` (
  ...
  `column_name` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `content_version` int(10) unsigned DEFAULT NULL,
  `content_old` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `content_new` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
